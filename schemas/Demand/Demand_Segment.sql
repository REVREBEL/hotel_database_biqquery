CREATE TABLE `devrebel-big-query-database.Demand.Demand_Segment`
(
  property_code STRING OPTIONS(description="Property code"),
  d360_segment STRING OPTIONS(description="Filters values for consumed revenue, room nights, and other metrics based on the Demand360 Segment. These segments are categorized by shared characteristics such as the type of rate, room type, and the booking channel used by the guest."),
