CREATE OR REPLACE VIEW `aparium-dataflow.PaceData.PaceData_Segment_030DayV` AS
...
SELECT
  ...
  curr.rms_cy - prior.rms_cy AS rms_cy_pickup_30d,
  curr.rev_cy - prior.rev_cy AS rev_cy_pickup_30d

FROM CurrentSnapshot curr

LEFT JOIN PriorSnapshot_30d prior
