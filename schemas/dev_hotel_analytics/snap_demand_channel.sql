CREATE TABLE `devrebel-big-query-database.dev_hotel_analytics.snap_demand_channel`
(
  ...
  channel STRING OPTIONS(description="Distribution channel (e.g., Brand.com, GDS, OTA)."),
