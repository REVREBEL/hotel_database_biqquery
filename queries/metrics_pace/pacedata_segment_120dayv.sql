CREATE OR REPLACE VIEW `aparium-dataflow.PaceData.PaceData_Segment_120DayV` AS
...
SELECT
  ...
  curr.rms_cy - prior.rms_cy AS rms_cy_pickup_120d,
  curr.rev_cy - prior.rev_cy AS rev_cy_pickup_120d

FROM CurrentSnapshot curr

LEFT JOIN PriorSnapshot_120d prior
